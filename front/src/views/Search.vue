<template>
  <div > 
    ...
    <b-container fluid>         
        <b-card  
            overlay
            img-src="https://picsum.photos/900/132/?image=3" 
            text-variant="white"                               
                ...
                <b-container fluid>
                            ...
                            <b-table-simple striped hover responsive>                        
                                <b-tbody>  
                                    <b-tr>
                                        ...
                                        <b-td class="text-left text-dark" text-light colspan="5">{{ url }}</b-td>
                                    </b-tr>                                    
                                    <b-tr>
                                        <b-th class="text-right" variant="dark" colspan="1">Servers Changed</b-th> 
                                        <b-td class="text-left text-dark" colspan="5">{{ changed }}</b-td>
                                    </b-tr>
                                    <b-tr>
                                        <b-th class="text-right" variant="dark" colspan="1">SSL Grade</b-th> 
                                        <b-td class="text-left text-dark" colspan="5">{{ ssl_grade }}</b-td>
                                    </b-tr>
                                    <b-tr>
                                        <b-th class="text-right" variant="dark" colspan="1">Previous SSL</b-th> 
                                        <b-td class="text-left text-dark" colspan="5">{{ previous }}</b-td>
                                    </b-tr>
                                    <b-tr> 
                                        <b-th class="text-right" variant="dark" colspan="1">Logo</b-th> 
                                        <b-td class="text-left text-dark" colspan="5">{{ logo }}</b-td>
                                    </b-tr>                           
                                    <b-tr> 
                                        <b-th class="text-right" variant="dark" colspan="1">Title</b-th> 
                                        <b-td class="text-left text-dark" colspan="5">{{ title }}</b-td>
                                    </b-tr> 
                                    <b-tr>
                                        <b-th class="text-right" variant="dark" colspan="1">Is Down</b-th>     
                                        <b-td class="text-left text-dark" colspan="5">{{ down }}</b-td>
                                    </b-tr>                                                                                                                                                                                                  
                                </b-tbody>
                            </b-table-simple> 
                        </b-collapse> 
                    ...
                    <div>
                        ...
                        <b-collapse id="accordion-2" accordion="my-accordion" role="tabpanel">
                            <b-table class="text-dark" variant="dark" hover :items="servers"></b-table>
                        </b-collapse> 
                    </div>                    
                </b-container>
            </b-card-text>
